...
Build a searchable knowledge base on its own subdomain or custom domain. Organize articles by category, publish when ready, and let users find answers with AI-powered semantic search. Available as an [experimental feature](/help-center/setup).
