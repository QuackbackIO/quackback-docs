...
2. **Complete onboarding** - Follow the setup wizard to create your account, name your workspace, pick what you want to start with (feedback, support, or a help center), and create your first board
...
After onboarding, the [launch checklist](/admin/getting-started) at Admin → Getting started walks you through the setup steps that matter for your goal. Common first stops:

- **Create a board** - Go to Admin → Settings → Boards
- **Invite your team** - Go to Admin → Settings → Members & Teams
