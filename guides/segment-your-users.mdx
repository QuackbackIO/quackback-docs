...
**Dynamic segments** use rules to automatically assign users. Set criteria like email domain, plan type, country, locale, last-active date, sign-up source, or activity level, and users are segmented automatically. Use dynamic segments for plan-based splits (everyone on the Enterprise plan), geo splits (everyone in the EU), or recency splits (anyone who's signed in within the last 30 days). See the [full attribute list](/admin/segments#built-in-attributes).
