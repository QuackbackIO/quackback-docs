...
Turn off real-time notifications if they're distracting. Set up a daily Slack digest or check [Feedback](/admin/inbox) at your designated time.
...
**Step 1: Check for stale posts (10 minutes).** Open [Feedback](/admin/inbox) and sort by oldest update, or use the date filters to find posts that haven't moved recently. For each one:
