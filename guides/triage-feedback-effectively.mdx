...
Turn off real-time notifications if they're distracting. Set up a daily Slack digest or check [Feedback](/admin/feedback) at your designated time.
...
**Step 1: Check for stale posts (10 minutes).** Open [Feedback](/admin/feedback) and sort by oldest update, or use the date filters to find posts that haven't moved recently. For each one:
...
**Step 2: Review top-voted posts (10 minutes).** Sort by votes. Are your highest-voted posts reflected in your [roadmap](/admin/roadmap)? If a post has 30 votes and doesn't match your roadmap's filter, either update its status or tags so it qualifies, or consciously decide not to and document why.
