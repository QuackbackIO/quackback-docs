...
- [ ] Access and sign-in are configured (see [Control portal access](/admin/portal-auth))
- [ ] Announcement is drafted
- [ ] You have time to respond to initial feedback within 48 hours

<Tip>
Launching a private beta? Set your portal to **Private** under [Portal access](/admin/portal-auth#portal-access), then let beta users in via [email invites](/admin/portal-auth#email-invites) or an [allowed segment](/admin/portal-auth#allowed-segments). You can flip back to Public when you're ready for general availability.
</Tip>
