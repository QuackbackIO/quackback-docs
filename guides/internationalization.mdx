...
description: "Configure language and locale settings for the widget and portal across nine supported languages."
icon: "language"
---
...
<Note>
Chinese resolves by script instead of a simple region strip: any tag that maximizes to Traditional (`zh-TW`, `zh-HK`, `zh-Hant`) resolves to `zh-tw`, everything else under `zh` resolves to `zh-cn`.
</Note>
