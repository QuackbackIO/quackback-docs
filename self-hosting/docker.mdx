...
description: "Deploy Quackback using Docker for the simplest production setup"
icon: "docker"
---

# Docker Deployment

Deploy Quackback using Docker for the simplest production setup.
...
docker run -d \
  ...
  -e BETTER_AUTH_URL="https://feedback.yourcompany.com" \
  -e ROOT_URL="https://feedback.yourcompany.com" \
