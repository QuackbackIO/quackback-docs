...
# Install PostgreSQL 17
sudo apt update
sudo apt install postgresql-17 postgresql-17-pgvector postgresql-17-cron
```
...
```bash
# Install PostgreSQL 17 repo
sudo dnf install -y https://download.postgresql.org/pub/repos/yum/reporpms/EL-9-x86_64/pgdg-redhat-repo-latest.noarch.rpm

# Install PostgreSQL and extensions
sudo dnf install -y postgresql17-server postgresql17-contrib postgresql17-pgvector postgresql17-pg_cron
```
