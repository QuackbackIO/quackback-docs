...
<Info>
Quackback uses native `uuidv7()` for ID generation, which requires PostgreSQL 18+.
</Info>
...
<Warning>
Securely manage all secrets including `BETTER_AUTH_SECRET`, database credentials, OAuth client secrets, and integration tokens. Use environment variables or a secrets management solution.
</Warning>
