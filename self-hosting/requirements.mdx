...
description: "Hardware and software requirements for self-hosting Quackback."
icon: "server"
---
...
| 6379 | Redis/Dragonfly | Internal only |
...
For higher loads, split HTTP serving from background processing across replicas. See [Scale with multiple replicas](/self-hosting/scaling).
