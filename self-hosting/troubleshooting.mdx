...
**Symptoms**: Queries fail with function error.

**Cause**: PostgreSQL version too old.

**Solution**: Upgrade to PostgreSQL 18+.

<Info>
Quackback requires PostgreSQL 18 or higher for native `uuidv7()` support used in ID generation.
</Info>
...
- [GitHub Discussions](https://github.com/quackbackhq/quackback/discussions)
