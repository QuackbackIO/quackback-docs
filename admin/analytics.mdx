...
| Visitors | Pageview and visitor trends, if enabled |

<Note>
A **Visitors** section appears here once you turn on [visitor analytics](/admin/visitors) in Admin → Settings → Labs, cookieless pageview tracking for your portal and widget.
</Note>
