...
<Note>
On [Quackback Cloud](/cloud), each Admin or Member uses a seat. Pending team invites hold a seat too. Portal invites are free. If every seat is in use, upgrade from **Admin → Settings → Plans & billing**.
</Note>
