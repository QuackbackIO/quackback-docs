...
description: "Keep users in the loop with statuses that show what's happening with their feedback."
icon: "circle-dot"
---

# Managing Statuses

Keep users in the loop. Statuses show what's happening with their feedback, from "Under Review" all the way to "Shipped".
...
Quackback comes with five statuses organized into three categories:
...
|--------|---------------|
| Under Review | New feedback being evaluated |
...
| Status | What it means |
|--------|---------------|
| Declined | Won't be implemented |

<Tip>
Completed posts are deprioritized when suggesting similar posts to new users so old shipped features don't clog up the suggestions.
</Tip>
...
Most teams show: **Planned → In Progress → Shipped**
