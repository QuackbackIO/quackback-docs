...
<Note>
On [Quackback Cloud](/cloud), the audit log is included on Enterprise.
</Note>
...
Signing in through the widget or from widget→portal never unlocks admin tools — even after you invite that person to your team. See [Session types](/auth/overview#session-types).
...
- [Session types](/auth/overview#session-types) — keep widget and admin access separate
