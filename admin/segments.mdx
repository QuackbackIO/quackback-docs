...
| Attribute | Type | Notes |
|-----------|------|-------|
| **Company plan** | string | The plan of the [company](/admin/companies) the user belongs to. |
| **Company monthly spend** | number | The company's MRR. |
| **Company size** | string | The company's size. |
| **Company industry** | string | The company's industry. |

<Tip>
Combine company and user conditions in the same segment, like "Company plan is Enterprise" and "Post Count is at least 1", to find engaged users at your biggest accounts.
</Tip>
...
Custom [company attributes](/admin/companies#custom-company-attributes), defined at **Admin → Settings → Companies**, show up in their own group in the rule builder alongside the built-in company fields above.
...
- [Manage companies](/admin/companies) - set up company attributes to target in segments
