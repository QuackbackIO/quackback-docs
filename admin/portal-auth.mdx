...
<Warning>
Widget sign-in requires a verified widget session (HMAC-signed `ssoToken`). Anonymous visitors and inline email capture are not strong enough to grant portal access.
</Warning>
