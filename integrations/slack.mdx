...
description: "See new feedback in Slack the moment it arrives. No more checking another dashboard."
icon: "slack"
---
...
**New post:**
```
📬 New post from jane@example.com
...
**Status change:**
```
🔄 Status updated by admin@example.com
