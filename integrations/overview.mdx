...
description: "Keep your team in the loop. Send feedback notifications to Slack, Linear, or your custom webhooks."
icon: "plug"
---

# Integrations Overview

Don't check another dashboard. Send feedback notifications where your team already works: Slack, Discord, Linear, or any tool via webhooks. Get notified about new feedback, status changes, and comments without leaving your workflow.
