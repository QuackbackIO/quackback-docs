---
title: "Webhooks"
description: "Receive real-time HTTP notifications when events occur in Quackback."
icon: "webhook"
---
...
Every webhook delivery is signed with HMAC-SHA256. Always verify the signature to confirm the request came from Quackback.
...
1. Create a Zap or n8n workflow with a webhook trigger
2. Copy the webhook URL
3. Create a Quackback webhook pointing to that URL
4. Map fields in your automation tool
