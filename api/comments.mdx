---
title: "Comments API"
description: "Server functions for creating, reading, updating, and deleting comments in Quackback"
icon: "message-circle"
---

# Comments API

This document covers all server functions for managing comments in Quackback.

## Overview

The Comments API provides functions for creating, reading, updating, and deleting comments, as well as reactions and pinning comments as official responses. Comments support threaded replies and emoji reactions.
...
## Pinning Comments (Official Response)
