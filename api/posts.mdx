---
title: "Posts API"
description: "Server functions for creating, reading, updating, and deleting posts in Quackback"
icon: "file-text"
---

# Posts API

This document covers all server functions for managing posts in Quackback.

## Overview

The Posts API provides functions for creating, reading, updating, and deleting posts, as well as voting and finding similar posts. Quackback uses TanStack Start server functions as the primary API layer.
