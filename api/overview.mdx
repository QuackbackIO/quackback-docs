---
title: "API Overview"
description: "Learn about Quackback's APIs for integrating with your applications and automating workflows"
icon: "code"
---

# API Overview

Quackback provides APIs for integrating with your applications and automating workflows.

## API Types

### Server Functions (RPC)

The primary API uses TanStack Server Functions—type-safe RPC endpoints:
