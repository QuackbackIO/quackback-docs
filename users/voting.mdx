...
Some workspaces require sign-in to ensure one vote per person, deliver status update notifications, and prevent vote manipulation. If the workspace has [anonymous voting](/admin/portal-auth#enable-anonymous-voting) enabled, you can vote without an account.
