---
title: "MCP Reference"
description: "Complete reference for Quackback's MCP tools and resources. Parameters, return values, and examples for all 22 tools and 5 resources."
order: 2
---

# MCP Reference

Quackback's MCP server exposes 22 tools and 5 resources. Tools perform actions (search, create, update, delete). Resources provide lookup data (boards, statuses, tags) that tools reference by ID.
