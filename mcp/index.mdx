...
| `write:article` | Create, update, publish, and delete articles and categories |
| `read:chat` | List and read support-inbox conversations, messages, tickets, and ticket threads |
| `write:chat` | Reply to conversations, change their status, and open, reply to, or note on tickets |
...
- [API Overview](/api/overview): REST API for programmatic integrations
