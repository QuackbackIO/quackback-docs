---
title: "Testing"
description: "Learn how to write and run unit tests with Vitest and E2E tests with Playwright"
icon: "flask"
---

# Testing

Quackback uses two testing frameworks: **Vitest** for unit tests and **Playwright** for end-to-end (E2E) tests.
