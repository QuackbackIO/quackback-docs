...
description: "Learn about the database layer including PostgreSQL, Drizzle ORM, and TypeIDs"
icon: "database"
---

# Database Guide

Understanding the database layer is essential for contributing to Quackback.
