...
description: "Understanding Quackback's architecture to navigate the codebase and make effective contributions"
icon: "sitemap"
---

# Architecture Overview

Understanding Quackback's architecture will help you navigate the codebase and make effective contributions.
...
The proxy handles:
- Self-hosted: Singleton connection
- Cloud: Per-tenant database from AsyncLocalStorage
...
├── Subdomain: workspace.quackback.io
└── Custom domain: feedback.company.com
        │
        ▼
Query catalog database for workspace
        │
        ▼
...
Store in AsyncLocalStorage context
        │
        ▼
All db.* calls use tenant database
```
