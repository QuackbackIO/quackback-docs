...
description: "Set up your local development environment for contributing to Quackback"
icon: "wrench"
---

# Development Setup

Set up your local development environment for contributing to Quackback.
