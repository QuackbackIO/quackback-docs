...
// Schema with validation rules. Note: board audience (public /
// authenticated / team / specific segments) is set separately via
...
const createBoardSchema = z.object({
  ...
  isPublic: z.boolean().default(true),  // shorthand: true → 'public', false → 'team'
})
