...
Identify signs the visitor in as a **customer in the widget** only. That sign-in never unlocks the admin dashboard — even if you later invite the same person to your team. See [Session types](/auth/overview#session-types).
