...
description: "Attribute widget votes and submissions to logged-in users, with optional HMAC verification."
icon: "finger-print"
---

# Identify users in the widget

When you identify a user, their votes and submissions in the widget are attributed to their account. Without identification, users see a prompt to sign in before they can vote.
...
Pass `null` to reset the widget identity when a user logs out:
