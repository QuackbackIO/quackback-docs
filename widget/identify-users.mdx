...
They stay a **customer** on the portal. Opening the portal from the widget does not grant admin access. See [Control portal access](/admin/portal-auth#widget-sign-in) and [Session types](/auth/overview#session-types).
