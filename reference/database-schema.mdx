...
description: "Comprehensive reference for the Quackback PostgreSQL database schema"
icon: "database"
---
...
<Tip>
When working with the database, always import from `@/lib/db` rather than `@quackback/db` directly. This ensures proper tenant handling in multi-tenant deployments.
</Tip>
