...
Enable AI features: post summaries, duplicate detection, feedback extraction, and help center semantic search. All AI features use the same API key via the OpenAI-compatible API.
