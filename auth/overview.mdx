...
description: "Learn about Quackback's authentication system powered by Better Auth, including portal users, team members, and security features"
icon: "lock"
---

# Authentication Overview

Quackback uses [Better Auth](https://better-auth.com/) for flexible, secure authentication.
