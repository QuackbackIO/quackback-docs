...
No more password resets. Quackback uses passwordless authentication (email codes or OAuth) so users sign in quickly and securely without another password to forget.
