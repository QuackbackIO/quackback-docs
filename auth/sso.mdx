...
<Note>
This page covers **team SSO** — sign-in for admins and members managing feedback. To let *portal users* (customers) sign in with a custom OIDC provider, see [Portal Authentication](/admin/portal-auth). On [Quackback Cloud](/cloud), SSO is included on Enterprise.
</Note>
