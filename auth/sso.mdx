...
description: "Let users sign in with their existing work accounts. Faster onboarding, better security."
icon: "building"
---
...
Client secrets are encrypted at rest using AES-256-GCM before being stored. The encryption key comes from your `ENCRYPTION_KEY` or `BETTER_AUTH_SECRET` environment variable.
