...
description: "Let users sign in with GitHub, Google, or Microsoft. One click and they're in."
icon: "key"
---

# OAuth Provider Setup

One-click sign-in. Let users authenticate with GitHub, Google, or Microsoft instead of managing another set of credentials. Works for both portal users (customers) and team members (your employees).
...
- [SSO](/auth/sso) - OIDC Single Sign-On for teams
